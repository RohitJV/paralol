...
void send_graph(pr_graph * graph, int cur_proc_rank) {	
	...
	MPI_Comm_rank(MPI_COMM_WORLD, &rank_of_the_proc);
  	...
  	MPI_Bcast( (void*)&(graph->total_nvtxs), 1, MPI_UNSIGNED_LONG, total_no_proc-1, MPI_COMM_WORLD );
  	MPI_Send( (void*)&(graph->nvtxs), 1,  MPI_UNSIGNED_LONG, cur_proc_rank, 0, MPI_COMM_WORLD);
  	MPI_Send( (void*)&(graph->nedges), 1,  MPI_UNSIGNED_LONG, cur_proc_rank, 0, MPI_COMM_WORLD);
  	MPI_Send( (void*)&(graph->start_vertex), 1,  MPI_UNSIGNED_LONG, cur_proc_rank, 0, MPI_COMM_WORLD);  	
  	MPI_Send( (void*)graph->xadj, graph->nvtxs + 1, MPI_UNSIGNED_LONG, cur_proc_rank, 0, MPI_COMM_WORLD);  	
...
int main(int argc, char *argv[]) {
	...
	if(rank_of_the_proc == total_no_proc-1) {
		...
		*/		
		graph->nvtxs = nvtxs;
	  	...
	  	MPI_Bcast( (void*)&(graph->total_nvtxs), 1, MPI_UNSIGNED_LONG, total_no_proc-1, MPI_COMM_WORLD );
		MPI_Recv( (void*)&(graph->nvtxs), 1, MPI_UNSIGNED_LONG, total_no_proc - 1, 0, MPI_COMM_WORLD, &recv_status);
		MPI_Recv( (void*)&(graph->nedges), 1, MPI_UNSIGNED_LONG, total_no_proc - 1, 0, MPI_COMM_WORLD, &recv_status);
		MPI_Recv( (void*)&(graph->start_vertex), 1, MPI_UNSIGNED_LONG, total_no_proc - 1, 0, MPI_COMM_WORLD, &recv_status);
		graph->xadj = malloc((graph->nvtxs + 1) * sizeof(*graph->xadj));
	  	graph->nbrs = malloc(graph->nedges * sizeof(*graph->nbrs));	  	
		MPI_Recv( (void*)(graph->xadj), graph->nvtxs + 1, MPI_UNSIGNED_LONG, total_no_proc - 1, 0, MPI_COMM_WORLD, &recv_status);		
	...
	***********************************************************************/
	...
	MPI_Alltoall( (void*)per_proc_count, 1, MPI_UNSIGNED_LONG, (void*)per_proc_count_recv, 1, MPI_UNSIGNED_LONG, MPI_COMM_WORLD);
	MPI_Alltoall( (void*)per_proc_outedges_count, 1, MPI_UNSIGNED_LONG, (void*)per_proc_outedges_count_recv, 1, MPI_UNSIGNED_LONG, MPI_COMM_WORLD);
	...
	MPI_Alltoallv( (void*)source_nodes_for_proc, (void*)per_proc_count, (void*)per_proc_count_disp, MPI_UNSIGNED_LONG, (void*)source_nodes_for_proc_recv, (void*)per_proc_count_recv, (void*)per_proc_count_disp_recv, MPI_UNSIGNED_LONG, MPI_COMM_WORLD);	
	pr_int* source_nodes_for_proc_count_recv = (pr_int*)malloc(total_size_recv * sizeof(pr_int));
	MPI_Alltoallv( (void*)source_nodes_for_proc_count, (void*)per_proc_count, (void*)per_proc_count_disp, MPI_UNSIGNED_LONG, (void*)source_nodes_for_proc_count_recv, (void*)per_proc_count_recv, (void*)per_proc_count_disp_recv, MPI_UNSIGNED_LONG, MPI_COMM_WORLD);			
	pr_int* outedges_in_proc_recv = (pr_int*)malloc(grand_total_size_recv * sizeof(pr_int));
	MPI_Alltoallv( (void*)outedges_in_proc, (void*)per_proc_outedges_count, (void*)per_proc_outedges_count_disp, MPI_UNSIGNED_LONG, (void*)outedges_in_proc_recv, (void*)per_proc_outedges_count_recv, (void*)per_proc_outedges_count_disp_recv, MPI_UNSIGNED_LONG, MPI_COMM_WORLD);			
